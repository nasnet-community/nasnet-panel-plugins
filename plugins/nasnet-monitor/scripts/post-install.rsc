...
/interface veth
add address=192.168.50.2/24 container-mac-address=02:00:00:00:00:06 dhcp=no \
    gateway=192.168.50.1 gateway6="" mac-address=02:00:00:00:00:05 name=veth1
/interface macvlan
...
/container
add file=disk1/nasnet-panel-dev-arm64.tar healthcheck-status="good, output: {\
    \"status\":\"healthy\",\"server\":\"nasnet-panel\",\"version\":\"dev-4f47f\
    3bf9e50ad4ae65dde44dc06f1a43a044216\"}\
    \n" interface=veth1 layer-dir="" logging=yes name=nnc root-dir=\
    /disk1/images/nnc start-on-boot=yes
/disk settings
...
/ip address
add address=192.168.50.1/24 interface=containers network=192.168.50.0
...
/ip firewall filter
add action=accept chain=forward comment=nasnet-panel-installer-forward \
    dst-address=192.168.50.2 dst-port=80 in-interface-list=!WAN protocol=tcp
...
/ip firewall nat
add action=dst-nat chain=dstnat comment=nasnet-panel-installer-dstnat \
    dst-port=8080 in-interface-list=!WAN protocol=tcp to-addresses=\
    192.168.50.2 to-ports=80
add action=masquerade chain=srcnat comment=nasnet-panel-installer-srcnat \
